...
public class BoardBatisTest {
	public static void main(String[] args) {
		...
		try {
			...
			paramMap.put("boardTitle", "제곧내");
			
			Map<String, Object> resultMap = session.selectOne("boardTest.getBoard2", paramMap);

			System.out.println("번호 : " + resultMap.get("BOARD_NO"));
			System.out.println("제목 : " + resultMap.get("BOARD_TITLE"));
			System.out.println("작성자 : " + resultMap.get("BOARD_WRITER"));
			System.out.println("날짜 : " + resultMap.get("BOARD_DATE"));
			System.out.println("내용 : " + resultMap.get("BOARD_CONTENT"));
